...
def main():
    ...
    print("=" * 70)
    print("✅ Проверка подписки добавлена")
    print("✅ Всё остальное как в оригинале")
    print("=" * 70)
